...
class StoreAboutusRequest extends FormRequest
{
    ...
    {
        return [
            'content_ar.required' => __('content_ar.required'),
            'content_ar.string' => __('content_ar.string'),
            'content_ar.max' => __('content_ar.max'),
            'content_en.required' => __('content_en.required'),
            'content_en.string' => __('content_en.string'),
            'content_en.max' => __('content_en.max'),
