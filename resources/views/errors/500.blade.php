...
<body>
    ...
    <div class="misc-wrapper">
        ...
        <div class="d-flex justify-content-center mt-5">
            <img src="{{ asset('dashboard/assets/img/illustrations/misc-under-maintenance-object.png') }}" alt="misc-under-maintenance"
                class="img-fluid misc-object d-none d-lg-inline-block" width="170" />
            <img src="{{ asset('dashboard/assets/img/illustrations/misc-bg-light.png') }}" alt="misc-under-maintenance"
            ...
            <div class="d-flex flex-column align-items-center">
                <img src="{{ asset('dashboard/assets/img/illustrations/misc-under-maintenance-illustration.png') }}"
