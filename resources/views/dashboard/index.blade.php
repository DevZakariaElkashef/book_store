...
@section('title') Dashboard - Analytics @endsection
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4">
                                <div class="avatar avatar-md flex-shrink-0 me-3">
                                    <div class="avatar-initial bg-lighter rounded">
                                        <div>
                                            <img src="{{ asset('dashboard/assets/img/icons/misc/3d-illustration.png') }}"
                                                alt="User" class="h-25" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex mb-4">
                                <div class="avatar avatar-md flex-shrink-0 me-3">
                                    <div class="avatar-initial bg-lighter rounded">
                                        <div>
                                            <img src="{{ asset('dashboard/assets/img/icons/misc/finance-app-design.png') }}"
                                                alt="User" class="h-25" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex mb-4">
                                <div class="avatar avatar-md flex-shrink-0 me-3">
                                    <div class="avatar-initial bg-lighter rounded">
                                        <div>
                                            <img src="{{ asset('dashboard/assets/img/icons/misc/4-square.png') }}"
                                                alt="User" class="h-25" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex mb-4">
                                <div class="avatar avatar-md flex-shrink-0 me-3">
                                    <div class="avatar-initial bg-lighter rounded">
                                        <div>
                                            <img src="{{ asset('dashboard/assets/img/icons/misc/delta-web-app.png') }}"
                                                alt="User" class="h-25" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex">
                                <div class="avatar avatar-md flex-shrink-0 me-3">
                                    <div class="avatar-initial bg-lighter rounded">
                                        <div>
                                            <img src="{{ asset('dashboard/assets/img/icons/misc/ecommerce-website.png') }}"
                                                alt="User" class="h-25" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-borderless">
                                        <thead class="border-bottom">
                                            <tr>
                                                ...
                                                <th class="pe-0 fw-medium text-heading">Conversion
                                                </th>
