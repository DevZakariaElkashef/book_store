    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('contact_types.index') }}" class="btn btn-primary">{{ __('Back') }}</a>

            </div>

            <div class="card-body">
                <form action="{{ route('contact_types.update', $contacttype->id) }}" method="post"
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ar" id="nameARInput"
                                    value="{{ old('name_ar') ?? $contacttype->name_ar }}">
                                @error('name_ar')
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_en" id="nameENInput"
                                    value="{{ old('name_en') ?? $contacttype->name_en }}">
                                @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="form-group">
                                ...
                                <select type="file" accept=".jpg,.png" class="form-control" name="is_active"
                                    ...
                                    <option value="0" @if (old('is_active') == 0 || $contacttype->is_active == 0) selected @endif>
                                        {{ __('Not Active') }}</option>
                                    <option value="1" @if (old('is_active') == 1 || $contacttype->is_active == 1) selected @endif>
                                        {{ __('Active') }}</option>
                                </select>
                                @error('avatar')
                                    <div class="text-danger">{{ $message }}</div>
