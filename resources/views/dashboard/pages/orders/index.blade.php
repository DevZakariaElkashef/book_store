                        ...
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                ...
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $totalOrdersCount }}</h4>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">Active Orders</p>
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $totalActiveOrdersCount }}</h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                ...
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $totalNotActiveOrdersCount }}</h4>
...
@section('js')
    ...
    <script src="{{ asset('dashboard/assets/js/app-order-list.js') }}"></script>
