                        ...
                        <div class="row mx-0">
                            <div class="col-md-7 mb-md-0 mb-4 ps-0">
                                <div class="d-flex svg-illustration align-items-center gap-2 mb-4">
                                    ...
                                    <span class="h4 mb-0 app-brand-text fw-bold">{{ $app->name }}</span>
                                </div>
                                    ...
                                    <dd class="col-sm-6">
                                        <div class="input-group input-group-merge disabled">
                                            ...
                                            <input type="text" class="form-control" disabled
                                                placeholder="{{ \App\Models\Order::latest()->first()->id + 1 }}"
                                                value="{{ \App\Models\Order::latest()->first()->id + 1 }}" id="invoiceId" />
                                        </div>
                                    </dd>
                                    <dt class="col-sm-6 mb-2 d-md-flex align-items-center justify-content-end">
                            ...
                            <div class="my-3">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="pe-3 fw-medium">Bank Number:</td>
                                            <td>{{ $bank->number }}</td>
                                        </tr>
                                        <tr>
