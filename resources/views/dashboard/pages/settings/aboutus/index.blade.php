            ...
            <div class="col-xl-9 col-lg-8 col-md-8">
                <div class="card overflow-hidden">
                    <div class="card-body">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item waves-effect delete-selection"
                                                data-url="{{ route('aboutus.delete') }}" href="javascript:void(0);"
                        ...
                        <div id="searchTable">
                            @include('dashboard.pages.settings.aboutus.table')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" id="createForm" action="{{ route('aboutus.store') }}" enctype="multipart/form-data">
                    @csrf
