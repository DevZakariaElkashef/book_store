                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select type="text" class="form-control" name="university_id" id="univirsitySelect">
                                    @foreach ($universities as $university)
                                        <option value="{{ $university->id }}" @if(old('university_id') == $university->id || $contact->university_id == $university->id) selected @endif> {{ $university->name }} </option>
                                    @endforeach
                                </select>
                                @error('university_id')
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <textarea type="description" class="form-control" name="description_ar" id="descriptionARInput">{{ old('description_ar') ?? $contact->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <textarea type="description" class="form-control" name="description_en" id="descriptionENInput">{{ old('description_en') ?? $contact->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="file" accept=".jpg,.png" class="form-control" name="image"
                                    id="imageInput">
                                @if($contact->image)
                                <img style="max-width: 100px;" src="{{ asset($contact->image) }}" alt="">
                                @endif
                                @error('image')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <select type="file" accept=".jpg,.png" class="form-control" name="is_active"
                                    ...
                                    <option value="0" @if (old('is_active') == 0 || $contact->is_active == 0) selected @endif>
                                        {{ __('Not Active') }}</option>
                                    <option value="1" @if (old('is_active') == 1 || $contact->is_active == 1) selected @endif>
                                        {{ __('Active') }}</option>
                                </select>
                                @error('avatar')
                                    <div class="text-danger">{{ $message }}</div>
