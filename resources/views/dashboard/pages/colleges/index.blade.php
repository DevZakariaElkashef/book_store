    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">Total Colleges</p>
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $totalCollegesCount }}</h4>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">Active Colleges</p>
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $totalActiveCollegesCount }}</h4>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">Pending Colleges</p>
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $totalNotActiveCollegesCount }}</h4>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">{{ __("Colleges") }}</h5>
                    ...
                    <div class="col-sm-12 d-flex justify-content-center justify-content-md-end">
                        <div id="DataTables_Table_1_filter" class="dataTables_filter">
                            <label>
                                <input type="search" class="form-control search-in-db"
                                    data-url="{{ route('colleges.search') }}" placeholder="{{ __('search...') }}" aria-controls="DataTables_Table_1">
                            </label>
                            {{-- export --}}
                            <a class="dt-button add-new btn bg-label-primary" href="{{ route('colleges.export') }}">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item waves-effect delete-selection" data-url="{{ route('colleges.delete') }}" href="javascript:void(0);"
            ...
            <div id="searchTable">
                @include('dashboard.pages.colleges.table')
            </div>
        </div>
...
@section('js')
    ...
    <script src="{{ asset('dashboard/assets/js/app-college-list.js') }}"></script>
