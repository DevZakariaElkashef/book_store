                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">{{ __('Total Universities') }}</p>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">{{ __('Active Universities') }}</p>
                                <div class="d-flex align-items-center">
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                <p class="text-heading mb-2">{{ __('Pending Universities') }}</p>
                                <div class="d-flex align-items-center">
                        ...
                        <div id="DataTables_Table_1_filter" class="dataTables_filter">
                            <label>
                                <input type="search" class="form-control search-in-db"
                                    data-url="{{ route('universities.search') }}" placeholder="{{ __('search...') }}"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item waves-effect delete-selection"
                                    data-url="{{ route('universities.delete') }}" href="javascript:void(0);"
