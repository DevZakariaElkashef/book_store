                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ar" id="nameARInput"
                                    value="{{ old('name_ar') ?? $book->name_ar }}">
                                @error('name_ar')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_en" id="nameENInput"
                                    value="{{ old('name_en') ?? $book->name_en }}">
                                @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <textarea type="description" class="form-control" name="description_ar" id="descriptionARInput">{{ old('description_ar') ?? $book->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <textarea type="description" class="form-control" name="description_en" id="descriptionENInput">{{ old('description_en') ?? $book->description_en }}</textarea>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="offer_end_at" id="offerEndDateInput"
                                    value="{{ old('offer_end_at') ?? $book->offer_end_at }}">
                                @error('offer_end_at')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="form-group">
                                ...
                                <select type="file" accept=".jpg,.png" class="form-control" name="is_active"
                                    ...
                                    <option value="0" @if (old('is_active') == 0 || $book->is_active == 0) selected @endif>
                                        {{ __('Not Active') }}</option>
                                    <option value="1" @if (old('is_active') == 1 || $book->is_active == 1) selected @endif>
                                        {{ __('Active') }}</option>
                                </select>
                                @error('avatar')
                                    <div class="text-danger">{{ $message }}</div>
