...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
                        ...
                        <div id="DataTables_Table_1_filter" class="dataTables_filter">
                            <label>
                                <input type="search" class="form-control search-in-db"
                                    data-url="{{ route('notifications.search') }}" placeholder="{{ __('search...') }}"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item waves-effect delete-selection"
                                    data-url="{{ route('notifications.delete') }}" href="javascript:void(0);"
            ...
            <div id="searchTable">
                @include('dashboard.pages.notifications.table')
            </div>
        </div>
...
@section('js')
    ...
    <script src="{{ asset('dashboard/assets/js/app-notification-list.js') }}"></script>
