...
<body>
    ...
    <div class="misc-wrapper">
        ...
        <div class="d-flex justify-content-center mt-5">
            <img src="{{ asset('dashboard/assets/img/illustrations/misc-error-object.png') }}" alt="misc-error"
                class="img-fluid misc-object d-none d-lg-inline-block" width="160" />
            <img src="{{ asset('dashboard/assets/img/illustrations/misc-bg-light.png') }}" alt="misc-error"
            ...
            <div class="d-flex flex-column align-items-center">
                <img src="{{ asset('dashboard/assets/img/illustrations/misc-error-illustration.png') }}" alt="misc-error"
                    class="img-fluid zindex-1" width="190" />
                <div>
                    <a href="{{ route('dashboard.home') }}" class="btn btn-primary text-center my-4">Back to home</a>
                </div>
            </div>
        </div>
    </div>
